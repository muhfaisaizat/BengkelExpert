...
public class tambahJasa extends javax.swing.JDialog {

private koneksii koneksi;
    public tambahJasa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
try {
            ...
            String sql="INSERT INTO jasa VALUES (' "+id.getText()+" ' , ' "+nama.getText()+" ' , ' "+harga.getText()+" ' )";
