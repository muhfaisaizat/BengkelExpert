...
//        System.err.println("koneksi Gagal"+e.getMessage());
    ...
    public void tampiltabel(){
        TableActionEvent event=new TableActionEvent() {
            ...
            editPelanggan editDialog = new editPelanggan(null, true, rowDataString,pelanggan.this);
    ...
    try {
        ...
        java.sql.PreparedStatement pst = con.prepareStatement("DELETE FROM pelanggan WHERE ID_Pelanggan = ?");
...
//e.printStackTrace();
  ...
  tb.addColumn("ID Pelanggan");
    ...
    tb.addColumn("Aksi");
        ...
        try {
                     //m4ngwmbil data dari database
           res = stm.executeQuery("CALL cari_pelanggan('" + search1.getSearchText() + "');");
            while (res.next()){
                tb.addRow(new Object[]{
                    res.getString("ID_Pelanggan"),
                    res.getString("Nama"),
...
//            JOptionPane.showMessageDialog(null, "data gagal ditampilkan" + e.getMessage());
    ...
    private void initTambahData(){
        tambah1.setData(new ModelTambah("Tambah Pelanggan", new ImageIcon(getClass().getResource("/com/bengkel/icon/icons8-plus-40.png"))));
    ...
    new tambahPelanggann(null, true,this).setVisible(true);
