...
import com.bengkel.dialog.editbarangjadi;
import com.bengkel.dialog.tambahbarangjadi;
import com.bengkel.dialog.tambahbarangjadi1;
...
public class barangjadi extends javax.swing.JPanel {
...
//        System.err.println("koneksi Gagal"+e.getMessage());
    ...
    public void tampiltabel(){
        TableActionEvent event=new TableActionEvent() {
            ...
            editbarangjadi editDialog = new editbarangjadi(null, true, rowDataString,barangjadi.this);
    ...
    DefaultTableModel model = (DefaultTableModel) table1.getModel();
    String idbarangjadi = (String) model.getValueAt(row, 0); // Ambil nilai ID Pelanggan dari kolom pertama (index 0)
    
    // Hapus data dari SQL
    try {
        koneksimysql(); // Panggil metode koneksimysql() untuk menginisialisasi koneksi
        java.sql.PreparedStatement pst = con.prepareStatement("DELETE FROM barang_jadi WHERE ID_Barangjadi= ?");
        pst.setString(1, idbarangjadi);
        pst.executeUpdate();
  ...
  tb.addColumn("ID Barang Jadi");
    ...
    tb.addColumn("Aksi");
        ...
        try {
            ...
            res=stm.executeQuery("Select * from barang_jadi");
            while (res.next()){
...
//            JOptionPane.showMessageDialog(null, "data gagal ditampilkan" + e.getMessage());
  ...
  tb.addColumn("ID Barang Jadi");
    ...
    tb.addColumn("Aksi");
        ...
        try {
                     //m4ngwmbil data dari database
            res = stm.executeQuery("CALL cari_barang_jadi('" + search1.getSearchText() + "');");
            while (res.next()){
                tb.addRow(new Object[]{
                    res.getString("ID_Barangjadi"),
                    res.getString("Nama_Barang"),
...
//            JOptionPane.showMessageDialog(null, "data gagal ditampilkan" + e.getMessage());
    ...
    private void initTambahData(){
        tambah1.setData(new ModelTambah("Tambah Barang Jadi", new ImageIcon(getClass().getResource("/com/bengkel/icon/icons8-plus-40.png"))));
    ...
    private void initComponents() {
        ...
        table1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID_BarangJadi", "Nama ", "Harga", "stok", "Aksi"
            }
        ));
    ...
    new tambahbarangjadi1(null, true,this).setVisible(true);
