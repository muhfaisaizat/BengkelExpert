...
public class Action extends javax.swing.JPanel {
    ...
    public Action(ModelAction data) {
        ...
        cmdEdit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                data.getEvent().update(data.getStudent(),data.getPesanbarang(),data.getPelanggan());
            }
        });
        cmdDelete.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                data.getEvent().delete(data.getStudent(),data.getPesanbarang(),data.getPelanggan());
            }
        });
    }
    ...
    private void initComponents() {
        ...
        cmdEdit = new com.bengkel.swing.Button();
        cmdDelete = new com.bengkel.swing.Button();
    ...
    private com.bengkel.swing.Button cmdDelete;
    private com.bengkel.swing.Button cmdEdit;
